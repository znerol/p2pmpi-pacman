 ...
 * 
 * Zudem muess das Feld noch wissen ob es ein dickes oder ein schmalles Feld
 * ist. Dies ist nur wichtig fuer die Darstellung der Mauern. Schmalle Felder
 * werden weniger dick dargestellt, werden aber theoretisch als gleichgross
 * angeschaut wie die Anderen, da dies keinen Einfluss auf das Spiel hat.
 * 
...
public class Field {
     ...
     *            Ob schmale Breite
     */
    public Field(boolean free, Coord c) {
        coord = c;
        isFree = free;
        setShape();
    }
    ...
    private void setShape() {
        if (!isFree) {
            ...
            sizeX = GamePlay.GUI_FIELD_SIZE;
            posX = coord.getPointX() - GamePlay.GUI_FIELD_SIZE / 2;// .GUI_BIG_FREESPACE;

            sizeY = GamePlay.GUI_FIELD_SIZE;
            posY = coord.getPointY() - GamePlay.GUI_FIELD_SIZE / 2;// .GUI_BIG_FREESPACE;
            ...
            int posX = (coord.getPointX()) * GamePlay.GUI_SIZE_MULTIPLIER
                    - size / 2;
            int posY = (coord.getPointY()) * GamePlay.GUI_SIZE_MULTIPLIER
                    - size / 2;
     ...
     * 
     * @param coord
     *            Zu testende Koordinate
     * @return ob im Mittelpunkt
     */
    public boolean isField(Coord coord) {
        return (this.coord.getPointX() == coord.getPointX())
                && (this.coord.getPointY() == coord.getPointY());
    }
}
